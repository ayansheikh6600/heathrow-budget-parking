  ...
  return (
    <div className="p-4 shadow-[0_3px_15px_3px_rgba(0,0,0,0.2)] rounded-lg">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="block mb-2 text-sm sm:text-base">Title*</label>
          <input
            type="text"
            name="title"
        ...
        <div>
          <label className="block mb-2 text-sm sm:text-base">Contact Number*</label>
          <input
            type="text"
            name="contactNumber"
        ...
        <div>
          <label className="block mb-2 text-sm sm:text-base">People*</label>
          <input
            type="number"
            name="people"
        ...
        <div className="col-span-1 sm:col-span-2">
          <label className="block mb-2 text-sm sm:text-lg font-bold">Flight Details*</label>
  ...
  return (
    <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-10">
      ...
      <div className="p-4 shadow-[0_3px_15px_3px_rgba(0,0,0,0.2)] rounded-lg">
        ...
        <p className="text-gray-500 mb-4 sm:text-base text-xs text-center">Is Simply Dummy Text Of The Printing And Typesetting Industry.</p>
