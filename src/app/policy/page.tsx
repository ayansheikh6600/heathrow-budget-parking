                ...
                <div className='p-5 border-[#CACACA] border text-sm rounded-lg  w-full'>
                    <div className=" text-sm   sm:container  h-[485px] overflow-y-auto  sm:p-6 custom-scrollbar ">
                        <div className='sm:container'>
                            ...
                            <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Tracking &amp; Cookies Data</h3>
                            ...
                            <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Use of Data</h3>
                            ...
                            <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Transfer of Data</h3>
                            ...
                            <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Disclosure of Data</h3>
                            ...
                            <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Security of Data</h3>
                            <p>The security of your data is important to us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.</p>
                            <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Service Providers</h3>
                            ...
                            <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Analytics</h3>
                            ...
                            <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Links to Other Sites</h3>
                            <p>{"Our Service may contain links to other sites that are not operated by us. If you click on a third-party link, you will be directed to that third party's site. We strongly advise you to review the Privacy Policy of every site you visit. We have no control over and assume no responsibility for the content, privacy policies or practices of any third-party sites or services."}</p>
                            <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">{"Children's Privacy"}</h3>
                            ...
                            <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Changes to This Privacy Policy</h3>
                            ...
                            <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Contact Us</h3>
